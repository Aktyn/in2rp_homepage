...
const AsyncPages = {
	...
	StockExchange: __async(
		() => import(/*webpackChunkName: "players", webpackPrefetch: true */"./pages/luvineri")),
    ...
    <BrowserRouter>
    	<Layout>
    		<Switch>
	    		...
	    		<Route path='/luvineri/:id' component={AsyncPages.StockExchange} />
	    		<Route path='/luvineri' component={AsyncPages.StockExchange} />
