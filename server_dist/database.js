...
var connection_callback = undefined;
...
if (!mysql_login) {
    try { //ask user to type password in console
        ...
        console.error('You must specify mysql login adding --mysqllogin=LOGIN to console npm command');
        process.exit();
    }
}
...
const self = {
    ...
    init: function () {
        this.customQuery("CREATE TABLE IF NOT EXISTS `Whitelist`.`requests` (\
